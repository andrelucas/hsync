...
class FileHashCreateFromFilesystemTestCase(unittest.TestCase):
	...
	def test_create_from_file(self):
		...
		fh = FileHash.init_from_file('/etc/hosts',
										root='/etc/', defer_read=True)
	...
	def test_create_from_dir(self):
		...
		fh = FileHash.init_from_file('/tmp', root='/', defer_read=True)
	...
	def test_create_from_link(self):
		...
		fh = FileHash.init_from_file(lname, root=self.topdir, defer_read=True)
	...
	def test_create_from_device(self):
		...
		with self.assertRaises(UnsupportedFileTypeException):
			fh = FileHash.init_from_file('/dev/zero',
											root='/dev', defer_read=True)
